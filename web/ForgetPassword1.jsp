...
<body>
<form action="/dome/ForgetPasswordServlet1" method="post">
    <div id="kuang">
        ...
        <div id="kuang3">
            ...
            <div id="DIV">
                ...
                <div id="bgDIV">
                    <div>
                        <input type="text" placeholder="请输入账号" id="zhang" name="username" value="${username}" readonly="true"  >
                    </div>
                        <div>
                            <input type="password" placeholder="密码：包含大小写和数字，长度在8-10之间" id="mima" name="password" onblur="panduan()">
                        </div>
                        <div>
                            <input type="password" placeholder="与上一次密码一致" id="quereng" onblur="panduan()">

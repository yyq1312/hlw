...
@WebServlet("/Deleteid1Servlet")
public class Deleteid1Servlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (yc1!=0){
            ...
            ArrayList<CommodityBeen> list1 = new ArrayList<>();
            list1 = sc.chaxun2(yc11,fy1);
            if (list1.size()==0){
                if (fy1!=0){
                    fy1 = fy1-7;
                }
            ...
            ArrayList<CommodityBeen> list1=sc.chaxun2(fy1);
            if (list1.size()==0) {
                if (fy1 != 0) {
                    fy1 = fy1 - 7;
                }
            }
            list1=sc.chaxun2(fy1);
            JSONArray data = JSONArray.fromObject(list1);
            PrintWriter printWriter = response.getWriter();
            printWriter.write(data.toString());
            printWriter.flush();
